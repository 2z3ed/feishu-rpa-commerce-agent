...
- P12-A：搜索商品返回候选卡片，卡片失败保留文本 fallback
- P12-B：候选卡片支持“加入监控”按钮，点击后可成功纳管
- P12-C：监控对象管理卡片支持“暂停监控”/“恢复监控”
- P12-D：监控对象超过 5 条时支持“查看更多”，下一页保留暂停/恢复按钮
...
当前主线不是继续堆新功能，而是把飞书卡片交互层收口到可演示、可回归、可交接的稳定版本。
...
- 文档口径统一（README + `docs/p12` 四份约束文档）
- 演示路径固化（老板 SOP 一条链路走通）
- 回归命令固化（P10-B + P12-B/C/D）
- 老板可读错误提示统一
